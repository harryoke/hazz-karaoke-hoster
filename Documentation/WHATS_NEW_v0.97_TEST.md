# v0.97 test — Venue singer lists

This local test build adds saved venue singer lists, optional history loading, fresh lists, keeping selected regulars, clearing history and restoring singer backups. Follow [Venue Profiles](VENUE_PROFILES.md).

It also includes [rotation methods](ROTATION_METHODS.md), [manual-default rotation](FAIR_ROTATION.md), [CPU improvements](CPU_IMPROVEMENTS.md) and [v0.95 features](WHATS_NEW_v0.95.md).
