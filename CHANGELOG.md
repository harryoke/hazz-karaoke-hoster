...
Archived release notes from the former README. Version-specific requirements and validation notes describe those historical builds. For the app overview and current downloads, see [README](README.md).
